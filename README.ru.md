...
10/12 — на отдельном листе вопросов. Локальный срез GSM8K (первые 200 из
1 319 пунктов основного теста, жадное декодирование, `max_new_tokens = 256`)
есть только на этой картинке — это не опубликованный счёт GSM8K. В подвале —
один живой дымовой ряд bitsandbytes NF4 (22,8 ток/с / 57 мс); это другой
стек, не сравнение ядер. Пластина суммирует; она не заменяет панель F
`lab-qwen25-14b.png` и не заменяет `hard-eval-qwen25.png`. Перерисовать:
