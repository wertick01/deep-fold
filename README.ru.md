...
bitsandbytes или llama.cpp: тех стеков здесь не мерили (строки SKIP, включая
пустую сетку линейного микробенча:
[`docs/runs/competitor-qwen25-3b/`](docs/runs/competitor-qwen25-3b/)).
...
- **Скорость выдачи сравнивает два разных стека:** с одной стороны
  ...
  **Не пишите, что deep-fold быстрее существующих 4-битных движков.** Marlin,
  AWQ, GPTQ/Marlin, ExLlamaV2, llama.cpp CUDA Q4 и vLLM здесь не засекались
  ([`docs/runs/competitor-qwen25-3b/`](docs/runs/competitor-qwen25-3b/) — все
  SKIP, и e2e, и именованный микробенч `[M,K]×[K,N]`). Изолированные venv потом:
