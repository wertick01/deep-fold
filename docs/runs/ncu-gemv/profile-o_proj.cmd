...
call "%NCU%" --target-processes all --kernel-name-base demangled --kernel-name regex:gemv_splitk --metrics "%METRICS%" --log-file C:\dev\deep-fold\docs\runs\ncu-gemv\qwen25-3b-o_proj-gemv.log -o C:\dev\deep-fold\docs\runs\ncu-gemv\qwen25-3b-o_proj-gemv.ncu-rep --force-overwrite %PY% -m gpu.nf4.bench_gemv_ncu --kind o_proj --iters 4 --reps 1 --l2-bytes 25165824
