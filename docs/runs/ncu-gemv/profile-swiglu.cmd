...
call "%NCU%" --target-processes all --kernel-name-base demangled --kernel-name regex:gemv_swiglu --metrics "%METRICS%" --log-file C:\dev\deep-fold\docs\runs\ncu-gemv\qwen25-3b-swiglu-gemv.log -o C:\dev\deep-fold\docs\runs\ncu-gemv\qwen25-3b-swiglu-gemv.ncu-rep --force-overwrite %PY% -m gpu.nf4.bench_gemv_ncu --kind swiglu --iters 4 --reps 1 --l2-bytes 25165824
